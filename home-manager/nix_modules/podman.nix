...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.podman = {
      enable = true;
      containers = {
        ddns-go = lib.mkIf config.features.podman.ddns-go.enable {
    ...
    home.file.".config/systemd/user/podman-ddns-go.service.d/override.conf" = lib.mkIf config.features.podman.ddns-go.enable {
      text = ''
      [Service]
